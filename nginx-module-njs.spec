...
%define MODULE_CONFIGURE_ARGS $(echo "--add-dynamic-module=njs-0.2.8/nginx")
...
%build
cd %{bdir}/njs-0.2.8 && ./configure && make njs
cd %{bdir}
...
%{__install} -m644 %{bdir}/njs-0.2.8/CHANGES $RPM_BUILD_ROOT%{_datadir}/doc/nginx-module-njs/
%{__mkdir} -p $RPM_BUILD_ROOT%{_bindir}
%{__install} -m755 %{bdir}/njs-0.2.8/build/njs $RPM_BUILD_ROOT%{_bindir}/
