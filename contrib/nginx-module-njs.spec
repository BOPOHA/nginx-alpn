...
%define MODULE_CONFIGURE_ARGS $(echo "--add-dynamic-module=njs-0.2.3/nginx")
...
%build
cd %{bdir}/njs-0.2.3 && ./configure && make njs
cd %{bdir}
...
%{__install} -m644 %{bdir}/njs-0.2.3/CHANGES $RPM_BUILD_ROOT%{_datadir}/doc/nginx-module-njs/
%{__mkdir} -p $RPM_BUILD_ROOT%{_bindir}
%{__install} -m755 %{bdir}/njs-0.2.3/build/njs $RPM_BUILD_ROOT%{_bindir}/
